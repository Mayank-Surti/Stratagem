...
public class UnitSelector {
    ...
    private final int TXT_OFFSET = 45, BTN_OFFSET = 10, BTN_HEIGHT = 40;
    ...
    public void initButtons() {
        ...
        for (int i = 0; i < unitButtons.length; i++) {
            unitButtons[i] = new Button(availableUnits[i].getName(), TXT_OFFSET, 
                Y + BTN_OFFSET * 2 + (BTN_HEIGHT + BTN_OFFSET) * (i + 1), 200, BTN_HEIGHT);
        }
    }
