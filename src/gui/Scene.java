...
public abstract class Scene {
    ...
    protected void incrementSelectionY() {
        selectionY = increment(selectionY, maxSelection);
    }
    protected void decrementSelectionY() {
    	selectionY = decrement(selectionY, maxSelection);
    }
    protected void incrementSelectionX() {
        selectionX = increment(selectionX, maxSelection);
    }
    protected void decrementSelectionX() {
    	selectionX = decrement(selectionX, maxSelection);
    }
    ...
    protected void resetSelection(int newMax) {
    	selectionX = 1;
    	selectionY = 1;
    	maxSelection = newMax;
    }
