    ...
    public void draw(Graphics2D g2D) {
        ...
        switch (State.main) {
            ...
            switch (State.battle) {
                ...
                break;
                case MOVE:
                g2D.drawString("Select a location within the unit's walk range to move the chosen unit.", OFFSET, OFFSET * 2);
                break;
                case ATTACK:
                g2D.drawString("Select an enemy unit to attack. If no enemies are in the attack range, hit enter.", OFFSET, OFFSET * 2);
                break;
                case END:
